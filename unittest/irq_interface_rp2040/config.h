...
// The system-init routine needs this define to call the irq-init routine
#define HAS_DRIVER_IRQ 1
...
extern void* ut_get_RP2040_IRQ_GET_CLEAR_PENDING_REG(void);
extern void* ut_get_RP2040_IRQ_GET_SET_ENABLE_REG(void);
extern void* ut_get_RP2040_IRQ_GET_CLEAR_ENABLE_REG(void);

#define RP2040_IRQ_CLEAR_PENDING_REG_ADDRESS    ut_get_RP2040_IRQ_GET_CLEAR_PENDING_REG()
#define RP2040_IRQ_SET_ENABLE_REG_ADDRESS       ut_get_RP2040_IRQ_GET_SET_ENABLE_REG()
#define RP2040_IRQ_CLEAR_ENABLE_REG_ADDRESS     ut_get_RP2040_IRQ_GET_CLEAR_ENABLE_REG()
